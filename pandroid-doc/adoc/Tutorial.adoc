...
in PandroidActivity to provide your own Factories.
By default Pandroid enable view support for pre lollipop devices.
...
By default those view will be enable automatically like AppCompat Components.
