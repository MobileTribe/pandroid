package com.leroymerlin.pandroid.ui.loader;
...
public class ProgressWheel extends View {
    ...
    /**
     * Use onSizeChanged instead of onAttachedToWindow to getReceivers the dimensions of the view,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSpinning) {
            ...
            if (mustInvalidate && progressListener != null)
                progressListener.onProgressChanged(progress / 360.0f);
